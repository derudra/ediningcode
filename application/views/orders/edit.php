        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'orders/printDiv/'.$order_data['order']['id'] ?>" class="btn btn-default" >Bill</a>
                <button type="submit" class="btn btn-success">Save Changes</button>
                <a target="__blank" href="<?php echo base_url() . 'orders/printkot/'.$order_data['order']['id'] ?>" class="btn btn-default" >KOT</a>
